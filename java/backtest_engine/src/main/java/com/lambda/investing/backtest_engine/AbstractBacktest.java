...
public abstract class AbstractBacktest {
	...
	protected TradingEngineConnector paperTradingEngine;
	protected PaperExecutionReportConnectorPublisher paperExecutionReportConnectorPublisher;
	...
	protected void afterConstructor() {
		...
		algorithmConnectorConfiguration = new AlgorithmConnectorConfiguration(paperTradingEngine,
	...
	protected abstract TradingEngineConnector getPaperTradingEngine();
	...
	protected MarketDataConnectorPublisher getOrdinaryMarketDataConnectorPublisher() {
		if (backtestConfiguration.getBacktestSource().equals(BacktestSource.csv)) {
			CSVFileConfiguration csvFileConfiguration = new CSVFileConfiguration(backtestConfiguration.getInstrument(),
			...
			ParquetFileConfiguration parquetFileConfiguration = new ParquetFileConfiguration(
					backtestConfiguration.getInstrument(), backtestConfiguration.getSpeed(),
	...
	public void start() throws LambdaException {
		...
		paperExecutionReportConnectorPublisher.setInstrumentsList(backtestConfiguration.getInstrument());
		paperExecutionReportConnectorPublisher.setPaperConnectorMarketDataAndExecutionReportPublisher(
				paperConnectorMarketDataAndExecutionReportPublisher);
		paperExecutionReportConnectorPublisher.init();
