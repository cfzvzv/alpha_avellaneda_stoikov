...
public class CSVZeroMqBacktest extends AbstractBacktest {
	...
	@Override protected MarketDataProvider getAlgorithmMarketDataProvider() {
		ZeroMqMarketDataConnector zeroMqMarketDataConnector = new ZeroMqMarketDataConnector(
				(ZeroMqConfiguration) marketDataConnectorConfiguration, backtestConfiguration.getInstrument(),
	...
	protected void readFiles() {
		...
		if (paperTradingEngine instanceof ZeroMqTradingEngineConnector) {
			ZeroMqTradingEngineConnector zeroMqTradingEngineConnector = (ZeroMqTradingEngineConnector) paperTradingEngine;
