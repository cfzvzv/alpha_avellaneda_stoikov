...
public class MarketMakerMarketDataExecutionReportListener implements MarketDataListener, ExecutionReportListener {
	...
	Logger logger = LogManager.getLogger(PaperExecutionReportConnectorPublisher.class);
	private PaperExecutionReportConnectorPublisher tradingEngineConnector;

	public MarketMakerMarketDataExecutionReportListener(PaperExecutionReportConnectorPublisher tradingEngineConnector) {
