...
public class App {
	...
	static {
		...
		System.setProperty("java.library.path", "");// https://github.com/eclipse/deeplearning4j/issues/2981
	}
	...
	protected App(String[] springApplicationContextFiles) {
		...
		//		System.setProperty("log4j2.contextSelector", "log4j2.contextSelector");
