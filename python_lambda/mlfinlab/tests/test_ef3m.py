...
class TestM2NIter5(unittest.TestCase):
    ...
    def test_iter_5_validity_check_8(self):
        ...
        """
        moments_test = [1.7486117351052706, 12.30094642908807, 44.14804719610457, 301.66990880582324,
                        1389.7073066865096]
...
class TestMostLikelyParameters(unittest.TestCase):
    ...
    def test_most_likely_parameters_result(self):
        ...
        """
        mu_1_list = [-2.074149682208028, -2.1464760973734522, -1.7318027625411423, -1.7799163398785354,
                     -1.9766582333677596]
        mu_2_list = [0.9958122958772418, 0.9927128514876395, 1.013574632526087, 1.0065707257309104, 1.009533655971151]
        sigma_1_list = [1.9764097851543956, 1.9516780127056625, 2.080573657129795, 2.071328499049906,
                        1.9988591140726848]
        sigma_2_list = [1.002964090440232, 1.0054392587806025, 0.9872577865302316, 0.9909001363163131,
                        0.9971327048101786]
        p_1_list = [0.09668610445835334, 0.09379917992315062, 0.11351960785118335, 0.10993400151299484,
                    0.10264463363929438]
