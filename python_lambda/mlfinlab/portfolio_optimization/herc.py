...
class HierarchicalEqualRiskContribution:
    ...
    UniqueColors = ['darkred', 'deepskyblue', 'springgreen', 'darkorange', 'deeppink', 'slateblue', 'navy',
                    'blueviolet',
                    'pink', 'darkslategray']
    ...
    def allocate(self, asset_names=None, asset_prices=None, asset_returns=None, covariance_matrix=None,
        ...
        if asset_returns is None and (
                risk_measure in {'expected_shortfall', 'conditional_drawdown_risk'} or covariance_matrix is
